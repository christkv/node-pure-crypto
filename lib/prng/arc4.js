...
ARC4.prototype.init = ARC4.prototype.setKey;

ARC4.prototype.encrypt = function(block, index) {
  return this.crypt(block, index);
}

ARC4.prototype.decrypt = function(block, index) {
  return this.crypt(block, index);
}
...
ARC4.prototype.crypt = function(data, index) {
  var i = this.index1;
  var j = this.index2;
  var state = this.state;
