...
RIPEMD256.prototype.getDigestSize = function() {
  return DIGEST_LENGTH;
}

RIPEMD256.prototype.getByteLength = function() {
  return BYTE_LENGTH;
}
...
RIPEMD256.prototype.getAlgorithmName = function() {
  return "RIPEMD256";
}

//
// Common to all digests
RIPEMD256.prototype.doFinal = function(output, index) {
  this.finish();
  index = index == null ? 0 : index;
  // In place encode hash
