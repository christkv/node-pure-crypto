...
var RIPEMD320 = exports.RIPEMD320 = function() {
...
inherits(RIPEMD320, BaseDigest);

RIPEMD320.prototype.getDigestSize = function() {
  return DIGEST_LENGTH;
}

RIPEMD320.prototype.getByteLength = function() {
  return BYTE_LENGTH;
}

RIPEMD320.prototype.processWord = function(src, inOff) {
...
RIPEMD320.prototype.processBlock = function() {
  var self = this;
...
/*
 * f1,f2,f3,f4 are the basic RIPEMD320 functions.
 */
...
RIPEMD320.prototype.reset = function() {
  // General reset
...
RIPEMD320.prototype.processLength = function(bitLength) {
  if (this.xOff > 14) {
    this.processBlock();
  }
...
RIPEMD320.prototype.getAlgorithmName = function() {
  return "RIPEMD320";
}

//
// Common to all digests
RIPEMD320.prototype.doFinal = function(output, index) {
  this.finish();
  index = index == null ? 0 : index;
  // Encode hash in place
  ...
  util.inPlaceEncodeUInt32R(this.H5, output, index + 20);
  util.inPlaceEncodeUInt32R(this.H6, output, index + 24);
  util.inPlaceEncodeUInt32R(this.H7, output, index + 28);
  util.inPlaceEncodeUInt32R(this.H8, output, index + 32);
  util.inPlaceEncodeUInt32R(this.H9, output, index + 36);  
  this.reset();  
