...
RIPEMD320.prototype.digestSize = function() {
...
RIPEMD320.prototype.algorithmName = function() {
  return "RIPEMD320";
}

//
// Common to all digests
RIPEMD320.prototype.digest = function(encoding) {
  this.finish();
  ...
  util.inPlaceEncodeUInt32R(this.H8, output, 32);
  util.inPlaceEncodeUInt32R(this.H9, output, 36);
