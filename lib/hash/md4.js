...
MD4.prototype.getDigestSize = function() {
  return DIGEST_LENGTH;
}

MD4.prototype.getByteLength = function() {
  return BYTE_LENGTH;
}
...
MD4.prototype.getAlgorithmName = function() {
  return "MD4";
}

//
// Common to all digests
MD4.prototype.doFinal = function(output, index) {
  // add padding
  this.finish();
