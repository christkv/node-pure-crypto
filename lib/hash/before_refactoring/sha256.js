...
SHA256.prototype.digestSize = function() {
...
SHA256.prototype.digest = function(encoding) {
  ...
  this.finish();
  // Ouput digest
  var output = new Array(28);
  util.inPlaceEncodeUInt32(this.H1, output, 0);
  util.inPlaceEncodeUInt32(this.H2, output, 4);
  util.inPlaceEncodeUInt32(this.H3, output, 8);
  util.inPlaceEncodeUInt32(this.H4, output, 12);
  util.inPlaceEncodeUInt32(this.H5, output, 16);
  util.inPlaceEncodeUInt32(this.H6, output, 20);
  util.inPlaceEncodeUInt32(this.H7, output, 24);
  util.inPlaceEncodeUInt32(this.H8, output, 28);
  // Reset
  this.reset();
...
SHA256.prototype.algorithmName = function() {
  return "SHA-256";
}
