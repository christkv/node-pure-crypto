...
var SHA384 = exports.SHA384 = function() {
  // Setup SHA384
  this.W = new Array(80);
...
SHA384.prototype.digestSize = function() {
 ...
 */
SHA384.prototype.adjustByteCounts = function() {
...
SHA384.prototype.processLength = function(lowW, hiW) {
  if (this.wOff > 14) {
    this.processBlock();
  }
...
SHA384.prototype.processBlock = function() {
...
var Sum0 = function(x) {
  return x.shiftLeft(36).or(x.shiftRightUnsigned(28)).xor(x.shiftLeft(30).or(x.shiftRightUnsigned(34))).xor(x.shiftLeft(25).or(x.shiftRightUnsigned(39)));
}
...
//
// Common to all digests
SHA384.prototype.update = function(src) {
...
SHA384.prototype.finish = function() {
  this.adjustByteCounts();
...
SHA384.prototype.algorithmName = function() {
  return "SHA-384";
}
...
SHA384.prototype.reset = function() {
  ...
  this.H1 = Long.fromString("cbbb9d5dc1059ed8", 16);
  this.H2 = Long.fromString("629a292a367cd507", 16);
  this.H3 = Long.fromString("9159015a3070dd17", 16);
  this.H4 = Long.fromString("152fecd8f70e5939", 16);
...
//
// Common to all digests
SHA384.prototype.digest = function(encoding) {
  // add padding
  this.finish();
  
  // Ouput digest
  var output = new Array(48);
  util.inPlaceEncodeUInt32(this.H1.getHighBits(), output, 0);
  util.inPlaceEncodeUInt32(this.H1.getLowBits(), output, 4);
  util.inPlaceEncodeUInt32(this.H2.getHighBits(), output, 8);
  util.inPlaceEncodeUInt32(this.H2.getLowBits(), output, 12);
  util.inPlaceEncodeUInt32(this.H3.getHighBits(), output, 16);
  util.inPlaceEncodeUInt32(this.H3.getLowBits(), output, 20);
  util.inPlaceEncodeUInt32(this.H4.getHighBits(), output, 24);
  util.inPlaceEncodeUInt32(this.H4.getLowBits(), output, 28);
  util.inPlaceEncodeUInt32(this.H5.getHighBits(), output, 32);
  util.inPlaceEncodeUInt32(this.H5.getLowBits(), output, 36);
  util.inPlaceEncodeUInt32(this.H6.getHighBits(), output, 40);
  util.inPlaceEncodeUInt32(this.H6.getLowBits(), output, 44);
  // Reset
  this.reset();
