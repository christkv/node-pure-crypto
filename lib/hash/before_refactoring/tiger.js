...
Tiger.prototype.digestSize = function() {
  return DIGEST_LENGTH;
}

Tiger.prototype.algorithmName = function() {
  return "Tiger";
}
...
//
// Common to all digests
Tiger.prototype.digest = function(encoding) {
  this.finish();
  
  var output = new Array(DIGEST_LENGTH);
  util.inPlaceEncodeUInt32R(this.a.getLowBits(), output, 0);
  util.inPlaceEncodeUInt32R(this.a.getHighBits(), output, 4);
  util.inPlaceEncodeUInt32R(this.b.getLowBits(), output, 8);
  util.inPlaceEncodeUInt32R(this.b.getHighBits(), output, 12);
  util.inPlaceEncodeUInt32R(this.c.getLowBits(), output, 16);
  util.inPlaceEncodeUInt32R(this.c.getHighBits(), output, 20);
