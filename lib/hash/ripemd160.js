...
//   
//   // debug("===================================================")
//   // debug("H0 = " + Long.fromNumber(this.H0).getLowBitsUnsigned().toString(16))
...
// 
//   // debug("  =================================================== 4")
//   // debug("  aa = " + Long.fromNumber(aa).getLowBitsUnsigned().toString(16))
//   // debug("  bb = " + Long.fromNumber(bb).getLowBitsUnsigned().toString(16))
//   // debug("  cc = " + Long.fromNumber(cc).getLowBitsUnsigned().toString(16))
//   // debug("  dd = " + Long.fromNumber(dd).getLowBitsUnsigned().toString(16))
// 
//   //
//   // Parallel round 2
//   //
