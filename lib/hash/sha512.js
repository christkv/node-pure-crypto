...
SHA512.prototype.digestSize = function() {
  return DIGEST_LENGTH;
}

SHA512.prototype.algorithmName = function() {
  return "SHA-512";
}
...
//
// Common to all digests
SHA512.prototype.update = function(src) {
...
//
// Common to all digests
SHA512.prototype.digest = function(encoding) {
  // add padding
  this.finish();
  ...
  util.inPlaceEncodeUInt32(this.H7.getHighBits(), output, 48);
  util.inPlaceEncodeUInt32(this.H7.getLowBits(), output, 52);
  util.inPlaceEncodeUInt32(this.H8.getHighBits(), output, 56);
  util.inPlaceEncodeUInt32(this.H8.getLowBits(), output, 60);
  // Reset
  this.reset();
