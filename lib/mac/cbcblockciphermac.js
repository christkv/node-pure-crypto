...
var CBCBlockCipherMac = exports.CBCBlockCipherMac = function(cipher, macSizeInBits, padding) {
  ...
  if(cipher != null) {    
    // debug("---------------------------- macSizeInBits :: " + macSizeInBits)
...
CBCBlockCipherMac.prototype.init = function() {
...
CBCBlockCipherMac.prototype.update = function() {
  ...
  if(args.length == 1 && !Array.isArray(args[0])) {
    ...
    if(len > gapLen) {
      // debug("   cbcblockciphermac :: buf :: " + util.toHex(this.buf))
      // debug("   cbcblockciphermac :: src :: " + util.toHex(src))
    ...
    // debug("   cbcblockciphermac :: buf :: " + util.toHex(this.buf))
    // debug("   cbcblockciphermac :: mac :: " + util.toHex(this.mac))    
  } else {
