...
ISAAC.prototype.getAlgorithmName = function() {
  return "ISAAC";
}
...
ISAAC.prototype.processBytes = function(src, index, len, out, outOff) {
  ...
  for(var i = 0; i < len; i++) {
    ...
    out[outOff + i] = this.keyStream[this.index] ^ src[index + i];
