...
var HC128 = exports.HC128 = function(key, iv) {
  // Store values
  this.key = key;
  this.iv = iv;
  this.cnt = 0;
...
HC128.prototype.encrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptStream(src);
}

HC128.prototype.updateEncrypt = function(src) {
...
HC128.prototype.finalEncrypt = function() {
  return "";  
}

HC128.prototype.encryptStream = function(src) {
  for(var i = 0; i < src.length; i++) {
    src[i] = src[i] ^ this.getByte();
  }
  return src;
}
...
HC128.prototype.decrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptStream(src);
}

HC128.prototype.updateDecrypt = function(src) {
  var data = !Array.isArray(src) ? util.binaryStringToArray(src) : src.slice(0);
  return util.arrayToBinaryString(this.encryptStream(data));
}

HC128.prototype.finalDecrypt = function() {
  return "";  
}