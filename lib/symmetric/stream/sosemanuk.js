...
Sosemanuk.prototype.getAlgorithmName = function() {
  return "SOSEMANUK";
}

Sosemanuk.prototype.reset = function() {  
}
...
Sosemanuk.prototype.processBytes = function(src, index, len, out, outOff) {
  index = index == null ? 0 : index;
  outOff = outOff == null ? 0 : outOff;
  
  for(var i = 0; i < len; i++) {
    out[outOff + i] = this.returnByte(src[index + i]);
  }  
}
