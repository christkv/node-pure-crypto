...
var ISAAC = exports.ISAAC = function(key, iv) {
  this.sizeL = 8;
...
ISAAC.prototype.encrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptStream(src);
}

ISAAC.prototype.updateEncrypt = function(src) {
  var data = !Array.isArray(src) ? util.binaryStringToArray(src) : src;
  return util.arrayToBinaryString(this.encryptStream(data));
}

ISAAC.prototype.finalEncrypt = function() {
  return "";  
}

ISAAC.prototype.encryptStream = function(src) {
  var self = this;
...
ISAAC.prototype.decrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptStream(src);
}

ISAAC.prototype.updateDecrypt = function(src) {
  var data = !Array.isArray(src) ? util.binaryStringToArray(src) : src;
  return util.arrayToBinaryString(this.encryptStream(data));
}

ISAAC.prototype.finalDecrypt = function() {
  return "";  
}
