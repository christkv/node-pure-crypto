...
var HC256 = exports.HC256 = function(key, iv) {
  // Store values
  this.key = key;
  this.iv = iv;
  this.cnt = 0;
  ...
  //   debug("p[" + i + "] = " + p[i].toString(16))
  // }
  // 
  // debug("============================================================================ p")
  // for(var i = 0; i < 1024; i++) {
  //   debug("q[" + i + "] = " + q[i].toString(16))
  // }
...
HC256.prototype.encrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptStream(src);
}

HC256.prototype.updateEncrypt = function(src) {
...
HC256.prototype.finalEncrypt = function() {
  return "";  
}

HC256.prototype.encryptStream = function(src) {
...
HC256.prototype.decrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptStream(src);
}

HC256.prototype.updateDecrypt = function(src) {
  var data = !Array.isArray(src) ? util.binaryStringToArray(src) : src.slice(0);
  return util.arrayToBinaryString(this.encryptStream(data));
}

HC256.prototype.finalDecrypt = function() {
  return "";  
}