...
var Grain128 = exports.Grain128 = function() {  
}

Grain128.prototype.init = function(forEncryption, key, iv) {
...
Grain128.prototype.getAlgorithmName = function() {
  return "GRAIN128";
}

Grain128.prototype.reset = function() {  
}

Grain128.prototype.returnByte = function(input) {
  return input ^ this.getKeyStream();
}

Grain128.prototype.processBytes = function(src, index, len, out, outOff) {
