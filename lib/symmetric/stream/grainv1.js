...
var GrainV1 = exports.GrainV1 = function(key, iv) {  
...
GrainV1.prototype.encrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptStream(src);
}

GrainV1.prototype.updateEncrypt = function(src) {
  var data = !Array.isArray(src) ? util.binaryStringToArray(src) : src;
  return util.arrayToBinaryString(this.encryptStream(data));
}

GrainV1.prototype.finalEncrypt = function() {
  return "";  
}

GrainV1.prototype.encryptStream = function(src) {
  var self = this;
...
GrainV1.prototype.decrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptStream(src);
}

GrainV1.prototype.updateDecrypt = function(src) {
  var data = !Array.isArray(src) ? util.binaryStringToArray(src) : src;
  return util.arrayToBinaryString(this.encryptStream(data));
}

GrainV1.prototype.finalDecrypt = function() {
  return "";  
}
