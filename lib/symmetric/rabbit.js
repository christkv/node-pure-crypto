...
var Rabbit = exports.Rabbit = function(key, iv) {
  ...
  // If we have no iv create a random iv key
  // this.iv = iv != null ? iv : random.nextBytes(8);
  this.iv = iv;
  // Inner state
  this.x = [];
  this.c = [];
...
Rabbit.prototype.encrypt = function(block, index) {
  ...
  var ivWords = this.iv != null ? [util.decodeUInt32(this.iv, 0), util.decodeUInt32(this.iv, 4)] : null;  
    
  // Let's encrypt the content
  return this._rabbit(block, this.key, ivWords);
}
...
Rabbit.prototype._rabbit = function (m, k, iv) {
  // debug("=====================================================================")
  // debug("--------------------------------------------------- key")
  // debug(k)
  // debug("--------------------------------------------------- iv")
