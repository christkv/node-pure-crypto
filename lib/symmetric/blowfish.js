...
BlowFish.prototype.encrypt = function(block, index) {
  ...
  return this.encryptBlock(block, index);
}
 ...
 */
BlowFish.prototype.encryptBlock = function(src, srcIndex) {
...
BlowFish.prototype.decrypt = function(block, index) {
  index = index == null ? 0 : index;
  return this.decryptBlock(block, index);
}
 ...
 * exact multiple of our blocksize.
 */
BlowFish.prototype.decryptBlock = function(src, srcIndex) {
  var xl = util.decodeUInt32(src, srcIndex);
  var xr = util.decodeUInt32(src, srcIndex + 4);
