...
var BlowFish = exports.BlowFish = function(key) {
  this.key = key;
  // Initial
  this.S0 = [];
  this.S1 = [];
...
BlowFish.prototype.getBlockSize = function() {
  return BLOCK_SIZE;
}
 ...
 */
BlowFish.prototype.processTable = function(xl, xr, table) {
...
// BlowFish.prototype.updateEncrypt = function(src) {
//   return util.arrayToBinaryString(this.encrypt(src));
// }
// 
// BlowFish.prototype.finalEncrypt = function() {  
//   return "";
// }

BlowFish.prototype.encrypt = function(block, index) {
  index = index == null ? 0 : index;
  return this.encryptBlock(block, index, block, index);
}
 ...
 */
BlowFish.prototype.encryptBlock = function(src, srcIndex, dst, dstIndex) {
  var xl = util.decodeUInt32(src, srcIndex);
  var xr = util.decodeUInt32(src, srcIndex + 4);
  ...
  return util.encodeUInt32(xr).concat(util.encodeUInt32(xl));
}

BlowFish.prototype.decrypt = function(block, index) {
  index = index == null ? 0 : index;
  return this.decryptBlock(block, index, block, index);
}
 ...
 * exact multiple of our blocksize.
 */
BlowFish.prototype.decryptBlock = function(src, srcIndex, dst, dstIndex) {
  var xl = util.decodeUInt32(src, srcIndex);
  var xr = util.decodeUInt32(src, srcIndex + 4);
...
// BlowFish.prototype.updateDecrypt = function(src) {
//   return util.arrayToBinaryString(this.decrypt(src));
// }
// 
// BlowFish.prototype.finalDecrypt = function() {
//   return "";
// }
