...
Twofish.prototype.encryptBlock = function(block) {
  // Decode the integers
  ...
  return util.encodeUInt32(c).reverse()
...
Twofish.prototype.decryptBlock = function(block) {
  // Decode the integers
  var c = Long.fromNumber(util.decodeUInt32(block.slice(0, 4).reverse(), 0)).getLowBitsUnsigned();
  var d = Long.fromNumber(util.decodeUInt32(block.slice(4, 8).reverse(), 0)).getLowBitsUnsigned();
  var a = Long.fromNumber(util.decodeUInt32(block.slice(8, 12).reverse(), 0)).getLowBitsUnsigned();
  var b = Long.fromNumber(util.decodeUInt32(block.slice(12, 16).reverse(), 0)).getLowBitsUnsigned();
