...
Serpent.prototype.encryptBlock = function(block) {
  ...
  return util.encodeUInt32(d).reverse()
    .concat(util.encodeUInt32(e).reverse())
...
var beforeI7 = function(values, index, func) {
...
var afterI0 = function(values, index, func) {
...
var afterI1 = function(values, index, func) {
...
var afterI2 = function(values, index, func) {
...
var afterI3 = function(values, index, func) {
...
var afterI4 = function(values, index, func) {
...
var I0 = function(i, index, k, r0, r1, r2, r3, r4) {
  // r2 = ~r2;      \
...
var I1 = function(i, index, k, r0, r1, r2, r3, r4) {
  r4 = r1;
  r1 = Long.fromNumber(r1 ^ r3).getLowBitsUnsigned();
  r3 = Long.fromNumber(r3 & r1).getLowBitsUnsigned();
  r4 = Long.fromNumber(r4 ^ r2).getLowBitsUnsigned();
...
var I2 = function(i, index, k, r0, r1, r2, r3, r4) {
  r2 = Long.fromNumber(r2 ^ r3).getLowBitsUnsigned();
  r3 = Long.fromNumber(r3 ^ r0).getLowBitsUnsigned();
  r4 = r3;
...
var I3 = function(i, index, k, r0, r1, r2, r3, r4) {
  r4 = r2;
  r2 = Long.fromNumber(r2 ^ r1).getLowBitsUnsigned();
  r1 = Long.fromNumber(r1 & r2).getLowBitsUnsigned();
  r1 = Long.fromNumber(r1 ^ r0).getLowBitsUnsigned();
...
var I4 = function(i, index, k, r0, r1, r2, r3, r4) {
  r4 = r2;
  r2 = Long.fromNumber(r2 & r3).getLowBitsUnsigned();
  r2 = Long.fromNumber(r2 ^ r1).getLowBitsUnsigned();
  r1 = Long.fromNumber(r1 | r3).getLowBitsUnsigned();
...
var I5 = function(i, index, k, r0, r1, r2, r3, r4) {
...
var I6 = function(i, index, k, r0, r1, r2, r3, r4) {
  r0 = Long.fromNumber(r0 ^ r2).getLowBitsUnsigned();
  r4 = r2;
  r2 = Long.fromNumber(r2 & r0).getLowBitsUnsigned();
  r4 = Long.fromNumber(r4 ^ r3).getLowBitsUnsigned();
...
var I7 = function(i, index, k, r0, r1, r2, r3, r4) {
  r4 = r2;  
  r2 = Long.fromNumber(r2 ^ r0).getLowBitsUnsigned();
  r0 = Long.fromNumber(r0 & r3).getLowBitsUnsigned();
  r2 = Long.fromNumber(~r2).getLowBitsUnsigned();
...
var ILT = function(r, index, k, a, b, c, d, e) {
...
var KX = function(r, index, k, a, b, c, d, e) {
...
var LT = function(r, index, k, a, b, c, d, e) {
