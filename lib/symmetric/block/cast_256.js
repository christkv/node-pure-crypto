...
// Process a block
CAST256.prototype.processBlock = function(input, inOff, inLen) {
  inOff = inOff == null ? 0 : inOff;

  if(this.forEncryption) {
    cryptBlock(this, input, ENCRYPT, inOff);
  } else {
    cryptBlock(this, input, DECRYPT, inOff);
  }
}

// block must have length of BLOCKSIZE
// returns: crypted block
var cryptBlock = function(self, block, mode, index) {
