...
var CAST256 = exports.CAST256 = function() {
}

CAST256.prototype.init = function(forEncryption , in_key) {
  ...
  // Create keys
  if(forEncryption) {
    this.key = generateSubkeys(this, a, ENCRYPT);
  } else {
    this.key = generateSubkeys(this, a, DECRYPT);
  }  
}
...
var generateSubkeys = function(self, key, cryptmode) {
  var cr = 19;
  var mr = 17;
...
CAST256.prototype.getBlockSize = function() { return BlockSize; }
// Algorithm Name
CAST256.prototype.getAlgorithmName = function() { return "CAST256"; }
// Reset cipher
CAST256.prototype.reset = function() {}

// Process a block
CAST256.prototype.processBlock = function(input, inOff, out, outOff) {
  inOff = inOff == null ? 0 : inOff;
  outOff = outOff == null ? 0 : outOff;

  if(this.forEncryption) {
    return cryptBlock(this, input, ENCRYPT, inOff, out, outOff);
  } else {
    return cryptBlock(this, input, DECRYPT, inOff, out, outOff);
  }
}

// block must have length of BLOCKSIZE
// returns: crypted block
var cryptBlock = function(self, block, mode, index, out, outOff) {
  ...
  cryptBitBlock128(self, a, self.key);
  
  // Return the encrypted bytes
  util.inPlaceEncodeUInt32(a[0], out, outOff);
  util.inPlaceEncodeUInt32(a[1], out, outOff + 4);
  util.inPlaceEncodeUInt32(a[2], out, outOff + 8);
  util.inPlaceEncodeUInt32(a[3], out, outOff + 12);
  return BlockSize;
}

var cryptBitBlock128 = function(self, bitblock128, sk) {
  for(var i = 0; i < 6; i++) {
    forwardQuadround(bitblock128, sk, i);
  }
  
  for(var i = 6; i < 12; i++) {
    reverseQuadround(bitblock128, sk, i);    
  }
}
...
// changes: bitblock128
//  
var forwardQuadround = function(bitblock128, sk, i) {  
...
// changes: bitblock128
//  
var reverseQuadround = function(bitblock128, sk, i) {
  var d = f1(bitblock128[0], sk.kr[i][3], sk.km[i][3]);
  bitblock128[3] = Long.fromNumber(bitblock128[3]).xor(Long.fromNumber(d)).toNumber();
