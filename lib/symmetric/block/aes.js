...
// Input size of the block cipher
AES.prototype.getInputBlockSize = function() { return BLOCK_SIZE; }
// Output size of the block cipher
AES.prototype.getOutputBlockSize = function() { return BLOCK_SIZE; }

// Process a block
AES.prototype.processBlock = function(input, inOff, inLen) {
...
var decryptBlock = function(self, data, index) {
  var block = data;
  var round = 0;
  ...
  util.copy(data, index, self.state, 0, (Nb*4));
...
var encryptBlock = function(self, data, index) {
  var block = data;
  var round = 0;
  if(index == null) index = 0;
  // Copy array
