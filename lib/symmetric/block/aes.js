...
AESKey.prototype.expandKey = function() {
	...
	for(var idx = Nk; idx < Nb * (this.Nr + 1); idx++ ) {
...
AESKey.prototype.getBlockSize = function() { return 16; }

// decrypt one 128 bit block
AESKey.prototype.decrypt = function(data, index) {
  var block = data;
  var round = 0;
  if(index == null) index = 0;
  // Copy array
  this.state = block.slice(index, index + (Nb*4))
  // Start decryption
  ...
  util.copy(data, index, this.state, 0, (Nb*4));
...
AESKey.prototype.invMixSubColumns = function() {
  var tmp = this.tmp = [], i = 0;
	var XtimeE = this.xTimeE, XtimeB = this.xTimeB, XtimeD = this.xTimeD, Xtime9 = this.xTime9;
	var state = this.state;
	var InvSbox = this.invSBox;
...
AESKey.prototype.encrypt = function(data, index) {
  var block = data;
  var round = 0;
  if(index == null) index = 0;
  // Copy array
...
AESKey.prototype.mixSubColumns = function() {
  ...
  var tmp = this.tmp;
  var state = this.state;  
  var Xtime2Sbox = this.xTime2Sbox, Xtime3Sbox = this.xTime3Sbox;
  var Sbox = this.sBox;
...
AESKey.prototype.shiftRows = function() {
  var tmp = 0;
  var state = this.state, Sbox = this.sBox;
