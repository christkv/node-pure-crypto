...
// Process a block
Twofish.prototype.processBlock = function(input, inOff, inLen) {
...
var encryptBlock = function(self, block, srcIndex) {
  ...
  util.inPlaceEncodeUInt32R(c, block, srcIndex);
  util.inPlaceEncodeUInt32R(d, block, srcIndex + 4);
  util.inPlaceEncodeUInt32R(a, block, srcIndex + 8);
  util.inPlaceEncodeUInt32R(b, block, srcIndex + 12);
}
...
var decryptBlock = function(self, block, srcIndex) {
  ...
  util.inPlaceEncodeUInt32R(b, block, srcIndex + 4);
  util.inPlaceEncodeUInt32R(c, block, srcIndex + 8);
  util.inPlaceEncodeUInt32R(d, block, srcIndex + 12);
}
