...
var CAST128 = exports.CAST128 = function(key) {
  ...
  if(key.length < KeySize) {
	...
	// Schedule key
	this.keySchedule(key.slice(0, 16));
}

CAST128.prototype.keySchedule = function(inn) {
  var t = new Array(8);
	var k = new Array(32);
...
CAST128.prototype.getBlockSize = function() {
  return BlockSize;
}

CAST128.prototype.encrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.encryptBlock(src, index);
}

CAST128.prototype.encryptBlock = function(src, index) {
...
CAST128.prototype.decrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.decryptBlock(src, index);
}

CAST128.prototype.decryptBlock = function(src, index) {
  var l = src[index + 0]<<24 | src[index + 1]<<16 | src[index + 2]<<8 | src[index + 3];
	var r = src[index + 4]<<24 | src[index + 5]<<16 | src[index + 6]<<8 | src[index + 7];
	var t;
