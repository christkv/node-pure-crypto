...
AESKey.prototype.decrypt = function(src, index) {
  ...
  return this.decryptBlock(src.slice(index, index + BLOCK_SIZE), this.decryptionWorkingKey);
}

AESKey.prototype.decryptBlock = function(input, KW) {
  var C0 = util.decodeUInt32R(input, 0);
  var C1 = util.decodeUInt32R(input, 4);
  var C2 = util.decodeUInt32R(input, 8);
  var C3 = util.decodeUInt32R(input, 12);
  ...
  util.inPlaceEncodeUInt32R(C0, input, 0);
  util.inPlaceEncodeUInt32R(C1, input, 4);
  util.inPlaceEncodeUInt32R(C2, input, 8);
  util.inPlaceEncodeUInt32R(C3, input, 12);  
  return input;
}
...
AESKey.prototype.encrypt = function(src, index) {
  index = index == null ? 0 : index;  
  return this.encryptBlock(src.slice(index, index + BLOCK_SIZE), this.encryptionWorkingKey);
}

AESKey.prototype.encryptBlock = function(input, KW) {
  var C0 = util.decodeUInt32R(input, 0);
  var C1 = util.decodeUInt32R(input, 4);
  var C2 = util.decodeUInt32R(input, 8);
  var C3 = util.decodeUInt32R(input, 12);
