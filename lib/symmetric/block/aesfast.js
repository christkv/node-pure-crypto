...
AES.prototype.processBlock = function(input, inOff, inLen) {
  if(this.forEncryption) {
    encryptBlock(this, input, inOff, this.workingKey);
  } else {
    decryptBlock(this, input, inOff, this.workingKey);
  }
}
...
var decryptBlock = function(self, input, index, KW) {
...
var encryptBlock = function(self, input, index, KW) {
  var C0 = util.decodeUInt32R(input, index);
  var C1 = util.decodeUInt32R(input, index + 4);
  var C2 = util.decodeUInt32R(input, index + 8);
  var C3 = util.decodeUInt32R(input, index + 12);
