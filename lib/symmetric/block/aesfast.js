...
// Algorithm Name
AES.prototype.getAlgorithmName = function() { return "AES_FAST"; }
// Reset cipher
...
AES.prototype.processBlock = function(input, inOff, out, outOff) {
  ...
  if(this.forEncryption) {
    return encryptBlock(this, input, inOff, out, outOff, this.workingKey);
  } else {
    return decryptBlock(this, input, inOff, out, outOff, this.workingKey);
  }
}
...
var decryptBlock = function(self, input, index, out, outOff, KW) {
  ...
  util.inPlaceEncodeUInt32R(C0, out, outOff + 0);
  util.inPlaceEncodeUInt32R(C1, out, outOff + 4);
  util.inPlaceEncodeUInt32R(C2, out, outOff + 8);
  util.inPlaceEncodeUInt32R(C3, out, outOff + 12);  
  return BLOCK_SIZE;
}

var encryptBlock = function(self, input, index, out, outOff, KW) {
  var C0 = util.decodeUInt32R(input, index);
  var C1 = util.decodeUInt32R(input, index + 4);
  var C2 = util.decodeUInt32R(input, index + 8);
  var C3 = util.decodeUInt32R(input, index + 12);
  ...
  util.inPlaceEncodeUInt32R(C0, out, outOff);
  util.inPlaceEncodeUInt32R(C1, out, outOff + 4);
  util.inPlaceEncodeUInt32R(C2, out, outOff + 8);
  util.inPlaceEncodeUInt32R(C3, out, outOff + 12);  
  return BLOCK_SIZE;
