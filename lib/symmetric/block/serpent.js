...
var Serpent = exports.Serpent = function(key, rounds) {
  // Key Schedule
  this.key = Serpent.keySchedule(key, rounds);
}

Serpent.keySchedule = function(key, rounds) {
  key = key.slice(0);
...
Serpent.prototype.encryptBlock = function(block, srcIndex) {
  // Decode the integers
...
Serpent.prototype.decryptBlock = function(block, srcIndex) {
  // Decode the integers
  var a = Long.fromNumber(util.decodeUInt32R(block, srcIndex)).getLowBitsUnsigned();
  var b = Long.fromNumber(util.decodeUInt32R(block, srcIndex + 4)).getLowBitsUnsigned();
  var c = Long.fromNumber(util.decodeUInt32R(block, srcIndex + 8)).getLowBitsUnsigned();
