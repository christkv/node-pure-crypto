...
// Expose key scheduler for others to use
Serpent.keySchedule = keySchedule;
...
// Process a block
Serpent.prototype.processBlock = function(input, inOff, out, outOff) {
...
var encryptBlock = function(self, block, srcIndex, out, outOff) {
  // Decode the integers
  ...
  util.inPlaceEncodeUInt32R(e, out, outOff + 4);
  util.inPlaceEncodeUInt32R(b, out, outOff + 8);
  util.inPlaceEncodeUInt32R(a, out, outOff + 12);
  return BlockSize;
}

var decryptBlock = function(self, block, srcIndex, out, outOff) {
  // Decode the integers
  var a = Long.fromNumber(util.decodeUInt32R(block, srcIndex)).getLowBitsUnsigned();
  var b = Long.fromNumber(util.decodeUInt32R(block, srcIndex + 4)).getLowBitsUnsigned();
  var c = Long.fromNumber(util.decodeUInt32R(block, srcIndex + 8)).getLowBitsUnsigned();
  ...
  util.inPlaceEncodeUInt32R(d, out, outOff + 4);
  util.inPlaceEncodeUInt32R(b, out, outOff + 8);
  util.inPlaceEncodeUInt32R(e, out, outOff + 12);
  return BlockSize;
}
