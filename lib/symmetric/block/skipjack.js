...
// Process a block
SkipJack.prototype.processBlock = function(input, inOff, inLen) {
...
var encryptBlock = function(self, input, index) {
  var w1 = (input[index + 0] << 8) + (index + input[1] & 0xff);
  var w2 = (input[index + 2] << 8) + (index + input[3] & 0xff);
  var w3 = (input[index + 4] << 8) + (index + input[5] & 0xff);
  var w4 = (input[index + 6] << 8) + (index + input[7] & 0xff);
  var k = 0;
  ...
  util.inPlaceEncodeUInt16(w1, input, index + 0);
  util.inPlaceEncodeUInt16(w2, input, index + 2);
  util.inPlaceEncodeUInt16(w3, input, index + 4);
  util.inPlaceEncodeUInt16(w4, input, index + 6);
}
...
var decryptBlock = function(self, input, index) {
  ...
  util.inPlaceEncodeUInt16(w2, input, index + 0);
  util.inPlaceEncodeUInt16(w1, input, index + 2);
  util.inPlaceEncodeUInt16(w4, input, index + 4);
  util.inPlaceEncodeUInt16(w3, input, index + 6);
}
