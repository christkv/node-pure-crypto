...
var DES = exports.DES = function() {
}

DES.prototype.init = function(forEncryption, key) {
...
DES.prototype.getBlockSize = function() { return BlockSize; }
// Algorithm Name
DES.prototype.getAlgorithmName = function() { return "CAST128"; }
// Reset cipher
DES.prototype.reset = function() {}

// Process a block
DES.prototype.processBlock = function(input, inOff, inLen) {
  desFunc(this.key, input, inOff);  
}
