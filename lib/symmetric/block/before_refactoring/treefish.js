...
TreeFish.prototype.encrypt = function(src, index) {
  ...
  if(this.CIPHER_SIZE === 256) {
    return this.encryptBlock256(src, index);
  } else if(this.CIPHER_SIZE === 512) {
    return this.encryptBlock512(src, index);    
  } else if(this.CIPHER_SIZE === 1024) {
    return this.encryptBlock1024(src, index);    
  }
}

TreeFish.prototype.encryptLong = function(input) {
  if(this.CIPHER_SIZE === 256) {
    return this._encryptBlock256(input);
  } else if(this.CIPHER_SIZE === 512) {
    return this._encryptBlock512(input);
  } else if(this.CIPHER_SIZE === 1024) {
    return this._encryptBlock1024(input);
  }
}

TreeFish.prototype.encryptBlock256 = function(input, index) {
  var text = input;
  ...
  var result = this._encryptBlock256([b0, b1, b2, b3]);  
  return putBytes(result, input, index, this.BlockSize);  
}

TreeFish.prototype._encryptBlock256 = function(input) {
  var b0 = input[0];
  var b1 = input[1];
  var b2 = input[2];
  var b3 = input[3];
...
TreeFish.prototype.encryptBlock512 = function(input, index) {
  var text = input;
  if(Array.isArray(input)) text = util.toHex(input);
  // Unpack variables
  var b0 = Long.fromString(text.slice(index + 0, index + 16), 16);
  ...
  var result = this._encryptBlock512([b0, b1, b2, b3, b4, b5, b6, b7]);  
  return putBytes(result, input, index, this.BlockSize);  
}

TreeFish.prototype._encryptBlock512 = function(input) {
  var b0 = input[0];
  var b1 = input[1];
  var b2 = input[2];
  var b3 = input[3];
...
TreeFish.prototype.encryptBlock1024 = function(input, index) {
  var text = input;
  if(Array.isArray(input)) text = util.toHex(input);
  // Unpack variables
  var b0 = Long.fromString(text.slice(index + 0, index + 16), 16);
  ...
  var result = this._encryptBlock1024([b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15]);  
  return putBytes(result, input, index, this.BlockSize);  
}

TreeFish.prototype._encryptBlock1024 = function(input) {
  var b0 = input[0];
  var b1 = input[1];
  var b2 = input[2];
  var b3 = input[3];
...
TreeFish.prototype.decrypt = function(src, index) {
  index = index == null ? 0 : index;
  if(this.CIPHER_SIZE == 256) {
    return this.decryptBlock256(src, index);
  } else if(this.CIPHER_SIZE == 512) {
    return this.decryptBlock512(src, index);
  } else if(this.CIPHER_SIZE == 1024) {
    return this.decryptBlock1024(src, index);
  }
}

TreeFish.prototype.decryptBlock1024 = function(input, index) {
  var text = input;
  // Unpack variables
  ...
  return putBytes([b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15], input, index, this.BlockSize);
}

TreeFish.prototype.decryptBlock512 = function(input, index) {
  var text = input;
  // Unpack variables
  var b0 = Long.fromString(util.toHex(text.slice(index + 0, index + 8).reverse()), 16);
  var b1 = Long.fromString(util.toHex(text.slice(index + 8, index + 16).reverse()), 16);
  ...
  return putBytes([b0, b1, b2, b3, b4, b5, b6, b7], input, index, this.BlockSize);
}

TreeFish.prototype.decryptBlock256 = function(input, index) {
  var text = input;
  // Unpack variables
  var b0 = Long.fromString(util.toHex(text.slice(index + 0, index + 8).reverse()), 16);
  var b1 = Long.fromString(util.toHex(text.slice(index + 8, index + 16).reverse()), 16);
  ...
  return putBytes([b0, b1, b2, b3], input, index, this.BlockSize);
}
