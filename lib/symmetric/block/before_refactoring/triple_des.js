...
TripleDESKey.prototype.encrypt = function(block, index) {
  ...
  encrypted = this.desFunc(this.encKey2, encrypted, index);
  return this.desFunc(this.encKey3, encrypted, index);
}

TripleDESKey.prototype.decrypt = function(block, index) {
  index = index == null ? 0 : index;
  var decrypted = this.desFunc(this.decKey3, block, index);
  decrypted = this.desFunc(this.decKey2, decrypted, index);
  return this.desFunc(this.decKey, decrypted, index);
}
