...
Seed.prototype.encrypt = function(src, index) {
  ...
  return this.cryptBlock(src, this.encryptionKey, index);
}

Seed.prototype.cryptBlock = function(block, key, index) {
...
Seed.prototype.decrypt = function(src, index) {
  index = index == null ? 0 : index;
  return this.cryptBlock(src, this.deCryptionKey, index);
}
