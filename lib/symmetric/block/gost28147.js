...
var GOST28147_mainStep = function(S, n1, key) {
  var cm = (key + n1); // CM1
  // debug("key = " + key.toString(16));
  // debug("n1 = " + n1.toString(16));
  
  // S-box replacing
  var om = S[  0 + ((cm >> (0 * 4)) & 0xF)] << (0 * 4);
     // debug("om1 = " + om.toString(16));
     om += S[ 16 + ((cm >> (1 * 4)) & 0xF)] << (1 * 4);
     // debug("om2 = " + om.toString(16));
     om += S[ 32 + ((cm >> (2 * 4)) & 0xF)] << (2 * 4);
     // debug("om3 = " + om.toString(16));
     om += S[ 48 + ((cm >> (3 * 4)) & 0xF)] << (3 * 4);
     // debug("om4 = " + om.toString(16));
     om += S[ 64 + ((cm >> (4 * 4)) & 0xF)] << (4 * 4);
     // debug("om5 = " + om.toString(16));
     om += S[ 80 + ((cm >> (5 * 4)) & 0xF)] << (5 * 4);
     // debug("om6 = " + om.toString(16));
     om += S[ 96 + ((cm >> (6 * 4)) & 0xF)] << (6 * 4);
     // debug("om7 = " + om.toString(16));
     om += S[112 + ((cm >> (7 * 4)) & 0xF)] << (7 * 4);
     // debug("om8 = " + om.toString(16));
  // 11-leftshift
