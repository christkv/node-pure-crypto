...
var Gost28147 = exports.Gost28147 = function() {  
}

Gost28147.prototype.init = function(forEncryption, key, sbox) {
...
var generateWorkingKey = Gost28147.prototype.generateWorkingKey = function(key) {
...
Gost28147.prototype.getBlockSize = function() { return BlockSize; }
// Algorithm Name
Gost28147.prototype.getAlgorithmName = function() { return "GOST28147"; }
// Reset cipher
Gost28147.prototype.reset = function() {}

// Process a block
Gost28147.prototype.processBlock = function(input, inOff, out, outOff) {
  inOff = inOff == null ? 0 : inOff;
  outOff = outOff == null ? 0 : outOff;

  if(this.forEncryption) {
    return GOST28147Func(true, this.S, this.workingKey, input, inOff, out, outOff);
  } else {
    return GOST28147Func(false, this.S, this.workingKey, input, inOff, out, outOff);
  }
}

var GOST28147Func = function(forEncryption, S, workingKey, src, index, out, outOff) {
  var N1, N2, tmp;  //tmp -> for saving N1
  N1 = util.decodeUInt32R(src, index);
  N2 = util.decodeUInt32R(src, index + 4);
  ...
  // Map the output
  out[outOff + 3] = (N1 >> 24) & 0xff;
  out[outOff + 2] = (N1 >> 16) & 0xff;
  out[outOff + 1] = (N1 >> 8) & 0xff;
	out[outOff + 0] = N1 & 0xff;

  out[outOff + 7] = (N2 >> 24) & 0xff;
  out[outOff + 6] = (N2 >> 16) & 0xff;
  out[outOff + 5] = (N2 >> 8) & 0xff;
	out[outOff + 4] = N2 & 0xff;  
	return BlockSize;
}
