...
var generateWorkingKey = function(key) {
...
// Process a block
Gost28147.prototype.processBlock = function(input, inOff, inLen) {
  if(this.forEncryption) {
    // encryptBlock(this, input, inOff);
    GOST28147Func(true, this.S, this.workingKey, input, inOff);
  } else {
    // decryptBlock(this, input, inOff);    
    GOST28147Func(false, this.S, this.workingKey, input, inOff);
  }
}

// Gost28147.prototype.encrypt = function(src, index) {
//   index = index == null ? 0 : index;
//   return GOST28147Func(true, this.S, this.workingKey, src, index);
// }

// Gost28147.prototype.decrypt = function(src, index) {
//   index = index == null ? 0 : index;
//   return GOST28147Func(false, this.S, this.workingKey, src, index);
// }

var GOST28147Func = function(forEncryption, S, workingKey, src, index) {
  ...
  // Map the output
  src[index + 3] = (N1 >> 24) & 0xff;
  src[index + 2] = (N1 >> 16) & 0xff;
  src[index + 1] = (N1 >> 8) & 0xff;
	src[index + 0] = N1 & 0xff;

  src[index + 7] = (N2 >> 24) & 0xff;
  src[index + 6] = (N2 >> 16) & 0xff;
  src[index + 5] = (N2 >> 8) & 0xff;
	src[index + 4] = N2 & 0xff;  
	return src;
}
