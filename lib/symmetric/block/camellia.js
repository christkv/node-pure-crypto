...
var Camellia = exports.Camellia = function() {
}

Camellia.prototype.init = function(forEncryption, key) {
  var k = new Array(8);
  var ka = new Array(4);
  var kb = new Array(4);
  var t = new Array(4);  

  this.subKey = Array(24 * 4);
  this.kW = Array(4 * 4);
  this.kE = Array(6 * 4);
...
Camellia.prototype.getBlockSize = function() { return BlockSize; }
// Algorithm Name
Camellia.prototype.getAlgorithmName = function() { return "AES"; }
// Reset cipher
Camellia.prototype.reset = function() {}

// Process a block
Camellia.prototype.processBlock = function(input, inOff, inLen) {
  processBlock(this, input, inOff);
}

var processBlock = function(self, input, index) {
  if(self._keyIs128) {
    return processBlock128(input, index, self.subKey, self.kW, self.kE, self.state);
  } else {
    return processBlock192or256(input, index, self.subKey, self.kW, self.kE, self.state);
  }
}
...
Camellia.prototype.decryptBlock = function(input, index) {
  if(this._keyIs128) {
    return processBlock128(input, index, this.subKey, this.kW, this.kE, this.state);
  } else {
    return processBlock192or256(input, index, this.subKey, this.kW, this.kE, this.state);
  }
}
