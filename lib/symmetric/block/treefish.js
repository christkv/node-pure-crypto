...
TreeFish.prototype.encryptBlock256 = function(input) {
  ...
  // Unpack variables
  var b0 = Long.fromString(text.slice(0, 16), 16);
  var b1 = Long.fromString(text.slice(16, 32), 16);
  var b2 = Long.fromString(text.slice(32, 48), 16);
  var b3 = Long.fromString(text.slice(48, 64), 16);
  // Unpack key
  ...
  return putBytes([b0, b1, b2, b3], input, this.BlockSize);
}
...
TreeFish.prototype.encryptBlock512 = function(input) {
  ...
  var b2 = Long.fromString(text.slice(32, 48), 16);
  var b3 = Long.fromString(text.slice(48, 64), 16);
  var b4 = Long.fromString(text.slice(64 + 0, 64 + 16), 16);
  var b5 = Long.fromString(text.slice(64 + 16, 64 + 32), 16);
  var b6 = Long.fromString(text.slice(64 + 32, 64 + 48), 16);
  var b7 = Long.fromString(text.slice(64 + 48, 64 + 64), 16);
  // Unpack key
  var k0 = this.expanedKey[0];
  var k1 = this.expanedKey[1];
  var k2 = this.expanedKey[2];
  ...
  return putBytes([b0, b1, b2, b3, b4, b5, b6, b7], input, this.BlockSize);
}
...
TreeFish.prototype.encryptBlock1024 = function(input) {
  ...
  var b6 = Long.fromString(text.slice(64 + 32, 64 + 48), 16);
  var b7 = Long.fromString(text.slice(64 + 48, 64 + 64), 16);
  var b8 = Long.fromString(text.slice(128 + 0, 128 + 16), 16);
  var b9 = Long.fromString(text.slice(128 + 16, 128 + 32), 16);
  var b10 = Long.fromString(text.slice(128 + 32, 128 + 48), 16);
  var b11 = Long.fromString(text.slice(128 + 48, 128 + 64), 16);
  var b12 = Long.fromString(text.slice(192 + 0, 192 + 16), 16);
  var b13 = Long.fromString(text.slice(192 + 16, 192 + 32), 16);
  var b14 = Long.fromString(text.slice(192 + 32, 192 + 48), 16);
  var b15 = Long.fromString(text.slice(192 + 48, 192 + 64), 16);
  // Unpack key
  var k0 = this.expanedKey[0];
  var k1 = this.expanedKey[1];
  var k2 = this.expanedKey[2];
  ...
  // Return bytes
  return putBytes([b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15], input, this.BlockSize);
}
...
TreeFish.prototype.decryptBlock1024 = function(input) {
  var text = input;
  // Unpack variables
  var b0 = Long.fromString(util.toHex(text.slice(0, 8).reverse()), 16);
  var b1 = Long.fromString(util.toHex(text.slice(8, 16).reverse()), 16);
  var b2 = Long.fromString(util.toHex(text.slice(16, 24).reverse()), 16);
  var b3 = Long.fromString(util.toHex(text.slice(24, 32).reverse()), 16);
  var b4 = Long.fromString(util.toHex(text.slice(32 + 0, 32 + 8).reverse()), 16);
  var b5 = Long.fromString(util.toHex(text.slice(32 + 8, 32 + 16).reverse()), 16);
  var b6 = Long.fromString(util.toHex(text.slice(32 + 16, 32 + 24).reverse()), 16);
  var b7 = Long.fromString(util.toHex(text.slice(32 + 24, 32 + 32).reverse()), 16);
  var b8 = Long.fromString(util.toHex(text.slice(64 + 0, 64 + 8).reverse()), 16);
  var b9 = Long.fromString(util.toHex(text.slice(64 + 8, 64 + 16).reverse()), 16);
  var b10 = Long.fromString(util.toHex(text.slice(64 + 16, 64 + 24).reverse()), 16);
  var b11 = Long.fromString(util.toHex(text.slice(64 + 24, 64 + 32).reverse()), 16);
  var b12 = Long.fromString(util.toHex(text.slice(96 + 0, 96 + 8).reverse()), 16);
  var b13 = Long.fromString(util.toHex(text.slice(96 + 8, 96 + 16).reverse()), 16);
  var b14 = Long.fromString(util.toHex(text.slice(96 + 16, 96 + 24).reverse()), 16);
  var b15 = Long.fromString(util.toHex(text.slice(96 + 24, 96 + 32).reverse()), 16);
