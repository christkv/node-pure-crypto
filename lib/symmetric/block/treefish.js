...
// Process a block
TreeFish.prototype.processBlock = function(input, inOff, inLen) {
  inOff = inOff == null ? 0 : inOff;

  if(this.forEncryption) {
    if(this.CIPHER_SIZE === 256) {
      return encryptBlock256(this, input, inOff);
    } else if(this.CIPHER_SIZE === 512) {
      return encryptBlock512(this, input, inOff);
    } else if(this.CIPHER_SIZE === 1024) {
      return encryptBlock1024(this, input, inOff);
    }
  } else {
    if(this.CIPHER_SIZE == 256) {
      return decryptBlock256(this, input, inOff);
    } else if(this.CIPHER_SIZE == 512) {
      return decryptBlock512(this, input, inOff);
    } else if(this.CIPHER_SIZE == 1024) {
      return decryptBlock1024(this, input, inOff);
    }    
  }
}
...
var encryptBlock256 = function(self, input, index) {
  var text = input;
  ...
  return putBytes(result, input, index, self.BlockSize);  
}
...
var encryptBlock512 = function(self, input, index) {
  var text = input;
  if(Array.isArray(input)) text = util.toHex(input);
  // Unpack variables
  var b0 = Long.fromString(text.slice(index + 0, index + 16), 16);
...
var encryptBlock1024 = function(self, input, index) {
  var text = input;
  if(Array.isArray(input)) text = util.toHex(input);
  // Unpack variables
  var b0 = Long.fromString(text.slice(index + 0, index + 16), 16);
...
var decryptBlock1024 = function(self, input, index) {
  var text = input;
  // Unpack variables
  ...
  return putBytes([b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15], input, index, self.BlockSize);
}

var decryptBlock512 = function(self, input, index) {
  var text = input;
  // Unpack variables
  var b0 = Long.fromString(util.toHex(text.slice(index + 0, index + 8).reverse()), 16);
  var b1 = Long.fromString(util.toHex(text.slice(index + 8, index + 16).reverse()), 16);
  ...
  return putBytes([b0, b1, b2, b3, b4, b5, b6, b7], input, index, self.BlockSize);
}

var decryptBlock256 = function(self, input, index) {
  var text = input;    
  // Unpack variables
  var b0 = Long.fromString(util.toHex(text.slice(index + 0, index + 8).reverse()), 16);
  var b1 = Long.fromString(util.toHex(text.slice(index + 8, index + 16).reverse()), 16);
  ...
  return putBytes([b0, b1, b2, b3], input, index, self.BlockSize);
}
