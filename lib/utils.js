...
var hexStringToBinaryArray = exports.hexStringToBinaryArray = function(string) {
  ...
  var array = new Array(Math.floor(numberofValues));
...
var zeroedArray = exports.zeroedArray = function(size) {
...
var inPlaceEncodeUInt32R = exports.inPlaceEncodeUInt32R = function(value, buff, index) {
  buff[index + 3] = (value >> 24) & 0xff;			
	buff[index + 2] = (value >> 16) & 0xff;
	buff[index + 1] = (value >> 8) & 0xff;
...
var encodeUInt32R = exports.encodeUInt32R = function(value) {
  var buff = [];
...
var decodeUInt32R = exports.decodeUInt32R = function(array, index) {
